...
static const struct s_head lf_heads[] = {  
    ...
    { LINK(36), "pages",    VM_SEGMENTS,            IS_CONSTANT |   0x224},
    { LINK(37), "2dup",     MACRO(VMU_OVER,VMU_OVER,VMU_NOP),       0x225},
    { LINK(38), "!",        MACRO(VMU_ASTORE,VMU_STOREA,VMU_NOP),   0x226},
    { LINK(39), "@",        MACRO(VMU_ASTORE,VMU_FETCHA,VMU_NOP),   0x227},
    { LINK(40), "s@",       MACRO(VMU_ASTORE,VMU_FETCHASIGN,VMU_NOP), 0x227},
    { LINK(41), "nip",      MACRO(VMU_SWAP,VMU_DROP,VMU_NOP),       0x228},
    { LINK(42), "]",        API0(1),                                0x229},
    { LINK(43), "[",        API0(2),                 IS_IMMEDIATE | 0x229},
    { LINK(44), "emit",     API0(3),                                0x229},
    { LINK(45), ".",        API0(4),                                0x22A},
    { LINK(46), "'page",    API0(5),                                0x22B},
    { LINK(47), "um*",      API0(6),                                0x22C},
    { LINK(48), "m*",       API0(7),                                0x22D},
    { LINK(49), "}t",       API0(8),                                0x230},
    { LINK(50), "->",       API0(9),                                0x231},
    { LINK(51), "t{",       API0(10),                               0x232},
    { LINK(52), ">options", API0(11),                               0x233},
    { LINK(53), "options>", API0(12),                               0x234},
    { LINK(54), "(",        API0(13),                IS_IMMEDIATE | 0x235},
    { LINK(55), ".(",       API0(14),                               0x236},
    { LINK(56), "cr",       API0(15),                               0x237},
    { LINK(57), "words",    API0(16),                               0x238},
    { LINK(58), "'",        API0(17),                               0x239},
#if (FAT_FORTH & 1)
    { LINK(59), "hex",      API0(18),                               0x23A},
    { LINK(60), "decimal",  API0(19),                               0x23B},
#endif
};
